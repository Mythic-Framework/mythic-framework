...
DiamondPenthouse = {
    ...
    LoadDefault = function()
        ...
        DiamondPenthouse.Interior.Pattern.Set(DiamondPenthouse.Interior.Pattern.pattern02)
        DiamondPenthouse.Interior.Pattern.SetColor(DiamondPenthouse.Interior.Pattern.pattern02, DiamondPenthouse.Colors.timeless)
        ...
        DiamondPenthouse.Interior.Clutter.Clear(DiamondPenthouse.Interior.Clutter.bar)
